...
#parser.add_argument('--weights_folder', default='./weights', type=str) before
...
parser.add_argument('--name_model', default='model_unet01', type=str)
#parser.add_argument('--name_model', default='model_unet', type=str) #before
