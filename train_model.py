...
#     checkpoint = ModelCheckpoint(weights_path+'/model_best.keras', verbose=1, monitor='val_loss',save_best_only=True, mode='auto')
...
def training(path_save_spectrogram, weights_path, name_model, training_from_scratch, epochs, batch_size):
    ...
    generator_nn.save(weights_path + '/final_model.keras')  # Save the complete model
